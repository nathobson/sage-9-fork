...
add_action('wp_enqueue_scripts', function () {
    ...
    if (is_page_template('views/template-iframe.blade.php')) {
        wp_enqueue_script('sage/euroland.js', asset_path('scripts/euroland.js'), ['jquery'], null, true);
    }
}, 100);
...
add_action('after_setup_theme', function () {
    ...
    /**
     * Create @reset Blade directive to reset wp_query
     */
    sage('blade')->compiler()->directive('reset', function ($reset) {
